...
// Footer Link
define('CLASSIC_WOOCOMMERCE_FOOTER_LINK',__('https://theclassictemplates.com/themes/free-business-wordpress-theme/','classic-woocommerce'));

if ( ! defined( 'CLASSIC_WOOCOMMERCE_SUPPORT' ) ) {
define('CLASSIC_WOOCOMMERCE_SUPPORT',__('https://wordpress.org/support/theme/classic-woocommerce','classic-woocommerce'));
}
if ( ! defined( 'CLASSIC_WOOCOMMERCE_REVIEW' ) ) {
define('CLASSIC_WOOCOMMERCE_REVIEW',__('https://wordpress.org/support/theme/classic-woocommerce/reviews/#new-post','classic-woocommerce'));
}
if ( ! defined( 'CLASSIC_WOOCOMMERCE_PRO_DEMO' ) ) {
define('CLASSIC_WOOCOMMERCE_PRO_DEMO',__('https://theclassictemplates.com/demo/classic-woocommerce/','classic-woocommerce'));
}
if ( ! defined( 'CLASSIC_WOOCOMMERCE_THEME_PAGE' ) ) {
define('CLASSIC_WOOCOMMERCE_THEME_PAGE',__('https://www.theclassictemplates.com/themes/','classic-woocommerce'));
}
if ( ! defined( 'CLASSIC_WOOCOMMERCE_PREMIUM_PAGE' ) ) {
define('CLASSIC_WOOCOMMERCE_PREMIUM_PAGE',__('https://www.theclassictemplates.com/wp-themes/business-wordpress-theme/','classic-woocommerce'));
}
